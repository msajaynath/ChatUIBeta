...
public  class SeedClass {
    ...
    public List<ContactItem> seedContacts() {
        contacts.add(new ContactItem("Amalraj KR","",1, R.drawable.pic1));
        contacts.add(new ContactItem("Anand ","",2, R.drawable.pic2));
        contacts.add(new ContactItem("Mathew ","",3, R.drawable.pic3));
        contacts.add(new ContactItem("Mathew ","",4, R.drawable.pic6));
        contacts.add(new ContactItem("Paul barber ","",5, R.drawable.pic8));
        contacts.add(new ContactItem("Anuu ","",6, R.drawable.pic9));
        contacts.add(new ContactItem("Contact ","",7, R.drawable.pic1));
        contacts.add(new ContactItem("tester ","",8, R.drawable.pic12));
        return  contacts;
